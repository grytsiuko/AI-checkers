...
if __name__ == '__main__':
    ...
    # weights2 = [(10.363763848639543, 1), (15.159856060895263, 1), (-8.047162683502625, 1), (-6.177416936083562, 1), (1.2836879524393805, 1), (2.4525890533379453, 1), (0.40366537062433416, 1), (0.10549905282776095, 1)]

    # a = GenericHeuristic(weights1)
    # b = GenericHeuristic(weights2)
    a = AmountHeuristic()
    b = GenericHeuristic(weights1)
